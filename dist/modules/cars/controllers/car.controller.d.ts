...
export declare class CarController {
    static getAllCars: (req: Request, res: Response, next: import("express").NextFunction) => void;
    static getCarBySlug: (req: Request, res: Response, next: import("express").NextFunction) => void;
