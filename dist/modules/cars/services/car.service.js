...
class CarService {
    ...
    static async updateCar(id, carData) {
        ...
        return await car_model_1.Car.findByIdAndUpdate(id, carData, {
            returnDocument: "after",
        });
    }
    static async deleteCar(id) {
        return await car_model_1.Car.findByIdAndUpdate(id, { is_deleted: true }, { returnDocument: "after" });
    }
    static async restoreCar(id) {
        return await car_model_1.Car.findByIdAndUpdate(id, { is_deleted: false }, { returnDocument: "after" });
    }
}
