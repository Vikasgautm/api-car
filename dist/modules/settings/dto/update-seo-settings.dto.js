...
exports.UpdateSEOSettingsDto = void 0;
...
class UpdateSEOSettingsDto {
    static validate(data) {
        ...
        if (data.site_title !== undefined) {
            const requiredResult = validation_util_1.ValidationUtil.required(data.site_title, 'site_title');
            if (!requiredResult.valid) {
                errors.push(...requiredResult.errors);
            }
            else {
                const minLengthResult = validation_util_1.ValidationUtil.minLength(data.site_title, 3, 'site_title');
                if (!minLengthResult.valid) {
                    errors.push(...minLengthResult.errors);
                }
                const maxLengthResult = validation_util_1.ValidationUtil.maxLength(data.site_title, 100, 'site_title');
        ...
        if (data.site_description !== undefined) {
            const requiredResult = validation_util_1.ValidationUtil.required(data.site_description, 'site_description');
            if (!requiredResult.valid) {
                errors.push(...requiredResult.errors);
            }
            else {
                const minLengthResult = validation_util_1.ValidationUtil.minLength(data.site_description, 10, 'site_description');
                if (!minLengthResult.valid) {
                    errors.push(...minLengthResult.errors);
                }
        ...
        if (data.og_default_image !== undefined && data.og_default_image !== '') {
            const urlResult = validation_util_1.ValidationUtil.url(data.og_default_image);
            if (!urlResult.valid) {
        ...
        if (data.twitter_handle !== undefined && data.twitter_handle !== '') {
            const maxLengthResult = validation_util_1.ValidationUtil.maxLength(data.twitter_handle, 50, 'twitter_handle');
            if (!maxLengthResult.valid) {
                errors.push(...maxLengthResult.errors);
            }
        ...
        if (data.google_analytics_id !== undefined && data.google_analytics_id !== '') {
            const maxLengthResult = validation_util_1.ValidationUtil.maxLength(data.google_analytics_id, 50, 'google_analytics_id');
            if (!maxLengthResult.valid) {
                errors.push(...maxLengthResult.errors);
            }
        ...
        if (data.google_tag_manager_id !== undefined && data.google_tag_manager_id !== '') {
            const maxLengthResult = validation_util_1.ValidationUtil.maxLength(data.google_tag_manager_id, 50, 'google_tag_manager_id');
            if (!maxLengthResult.valid) {
                errors.push(...maxLengthResult.errors);
            }
        ...
        if (data.facebook_pixel_id !== undefined && data.facebook_pixel_id !== '') {
            const maxLengthResult = validation_util_1.ValidationUtil.maxLength(data.facebook_pixel_id, 50, 'facebook_pixel_id');
            if (!maxLengthResult.valid) {
                errors.push(...maxLengthResult.errors);
            }
...
//# sourceMappingURL=update-seo-settings.dto.js.map