...
export declare class BrandController {
    ...
    static updateBrand: (req: Request, res: Response, next: import("express").NextFunction) => void;
    static deleteBrand: (req: Request, res: Response, next: import("express").NextFunction) => void;
    static restoreBrand: (req: Request, res: Response, next: import("express").NextFunction) => void;
}
