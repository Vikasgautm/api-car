...
exports.VariantGroupingService = void 0;
...
class VariantGroupingService {
    ...
    static async applyGrouping(sessionId) {
        const variants = await VariantImportStaging_1.VariantImportStaging.find({
            import_session_id: new mongoose_1.Types.ObjectId(sessionId),
        ...
        for (const group of groups) {
            ...
            await VariantImportStaging_1.VariantImportStaging.updateMany({ _id: { $in: ids } }, {
                $set: {
...
exports.VariantGroupingService = VariantGroupingService;
//# sourceMappingURL=VariantGroupingService.js.map