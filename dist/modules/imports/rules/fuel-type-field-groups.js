...
exports.ICE_ONLY_NORMALIZED_PATHS = exports.EV_ONLY_RAW_KEYS = exports.EV_ONLY_NORMALIZED_PATHS = void 0;
exports.isElectricFuelType = isElectricFuelType;
exports.isHybridFuelType = isHybridFuelType;
exports.EV_ONLY_NORMALIZED_PATHS = [
...
exports.ICE_ONLY_NORMALIZED_PATHS = [
...
function isElectricFuelType(name) {
...
function isHybridFuelType(name) {
    const lower = name.toLowerCase().trim();
