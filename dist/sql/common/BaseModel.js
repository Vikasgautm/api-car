                ...
                if (typeof idVal === 'string' && idVal.startsWith('$')) {
                    ...
                    for (const key of keys) {
                        ...
                        if (typeof val === 'string' && val.startsWith('$')) {
                            ...
                            if (sourceCol.startsWith('car_doc.'))
                                sourceCol = sourceCol.substring(8);
                            if (sourceCol.startsWith('car.'))
                                sourceCol = sourceCol.substring(4);
                            if (sourceCol.startsWith('_id.'))
                                sourceCol = sourceCol.substring(4);
