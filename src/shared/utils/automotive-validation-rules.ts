...
export class AutomotiveValidationRules {
  static readonly rules: ValidationRule[] = [
    ...
    // Price validations
    {
      ...
      validate: (v) => {
        ...
        if (!exShowroom || !expected) return true;
    ...
    },
    {
      ...
      validate: (v) => {
        ...
        if (!exShowroom || !onRoad) return true;
    ...
    // Mileage/Range validations (logic checks only)
    {
      ...
      validate: (v) => {
        ...
        if (!city || !highway) return true;
        const cityNum = parseFloat(city as string);
        const hwNum = parseFloat(highway as string);
    ...
    // Dimension validations
    {
      ...
      validate: (v) => {
        ...
        if (!boot) return true;
        const bootNum = parseFloat(boot as string);
    ...
    },
    {
      ...
      validate: (v) => {
        ...
        if (!gc) return true;
        const gcNum = parseFloat(gc as string);
