...
export class BlogService {
  ...
  static async updateBlog(blogId: string, blogData: any) {
    ...
    if (blogData.article_type !== undefined) updateData.article_type = blogData.article_type;
    if (blogData.article_status !== undefined) updateData.article_status = blogData.article_status;
    if (blogData.article_intent !== undefined) updateData.article_intent = blogData.article_intent;
    if (blogData.target_keyword !== undefined) updateData.target_keyword = blogData.target_keyword;
    if (blogData.connected_cars !== undefined) updateData.connected_cars = blogData.connected_cars;
    if (blogData.connected_variants !== undefined) updateData.connected_variants = blogData.connected_variants;
    if (blogData.connected_brands !== undefined) updateData.connected_brands = blogData.connected_brands;
    if (blogData.connected_body_types !== undefined) updateData.connected_body_types = blogData.connected_body_types;
    if (blogData.connected_fuel_types !== undefined) updateData.connected_fuel_types = blogData.connected_fuel_types;
    if (blogData.connected_comparisons !== undefined) updateData.connected_comparisons = blogData.connected_comparisons;
    if (blogData.connected_collections !== undefined) updateData.connected_collections = blogData.connected_collections;
