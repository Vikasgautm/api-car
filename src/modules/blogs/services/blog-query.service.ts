...
export class BlogQueryService {
  static async getRelatedByCar(carId: string, limit = 5) {
    return Blog.find({
  ...
  static async getRelatedByBrand(brandId: string, limit = 5) {
    return Blog.find({
  ...
  static async getRelatedByFuelType(fuelId: string, limit = 5) {
    return Blog.find({
  ...
  static async getRelatedByBodyType(bodyTypeId: string, limit = 5) {
    return Blog.find({
  ...
  static async getRelatedByComparison(comparisonId: string, limit = 5) {
    return Blog.find({
