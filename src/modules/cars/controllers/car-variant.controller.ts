...
export class CarVariantController {
  ...
  static getAllAdminVariants = catchAsync(async (req: Request, res: Response) => {
    const result = await CarVariantService.getAllVariants(req.query, true);
  ...
  static createVariant = catchAsync(async (req: Request, res: Response) => {
    ...
    const variant = await CarVariantService.createVariant(createDto);
  ...
  static updateVariant = catchAsync(async (req: Request, res: Response) => {
    ...
    const variant = await CarVariantService.updateVariant(req.params.id as string, updateDto);
  ...
  static deleteVariant = catchAsync(async (req: Request, res: Response) => {
    await CarVariantService.deleteVariant(req.params.id as string);
    return ResponseUtil.success(res, null, 'Variant deleted successfully');
  });
  ...
  static togglePublish = catchAsync(async (req: Request, res: Response) => {
    const variant = await CarVariantService.togglePublish(req.params.id as string);
  ...
  static publishVariant = catchAsync(async (req: Request, res: Response) => {
    const variant = await CarVariantService.publishVariant(req.params.id as string);
  ...
  static unpublishVariant = catchAsync(async (req: Request, res: Response) => {
    const variant = await CarVariantService.unpublishVariant(req.params.id as string);
  ...
  static archiveVariant = catchAsync(async (req: Request, res: Response) => {
    const archivedBy = (req as any).user?.userId || undefined;
    const variant = await CarVariantService.archiveVariant(req.params.id as string, archivedBy);
  ...
  static unarchiveVariant = catchAsync(async (req: Request, res: Response) => {
    const variant = await CarVariantService.unarchiveVariant(req.params.id as string);
