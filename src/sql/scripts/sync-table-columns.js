...
async function main() {
  ...
  const universalColumns = [
    ...
    ['faq_id', 'VARCHAR(100) NULL'],
    ['question', 'TEXT NULL'],
    ['answer', 'TEXT NULL'],
    ['answer_format', 'VARCHAR(50) DEFAULT \'text\''],
    ['faq_group', 'VARCHAR(100) NULL'],
    ['view_count', 'INT DEFAULT 0'],
    ['click_count', 'INT DEFAULT 0'],
    ['faq_type', 'VARCHAR(100) DEFAULT \'editorial\''],
    ['intent_type', 'VARCHAR(100) NULL'],
    ['entity_type', 'VARCHAR(100) NULL'],
    ['entity_id', 'VARCHAR(100) NULL'],
    ['template_key', 'VARCHAR(100) NULL'],
    ['is_dynamic', 'TINYINT(1) DEFAULT 0'],
    ['is_editorial', 'TINYINT(1) DEFAULT 1'],
    ['source_type', 'VARCHAR(100) DEFAULT \'manual\''],
    ['canonical_intent_key', 'VARCHAR(255) NULL'],
    ...
    ['specs_raw', 'JSON NULL'],
    ['has_engine', 'TINYINT(1) DEFAULT 1'],
    ['has_battery', 'TINYINT(1) DEFAULT 0'],
    ['has_motor', 'TINYINT(1) DEFAULT 0'],
    ['has_external_charging', 'TINYINT(1) DEFAULT 0'],
    ...
    ['related_body_types', 'JSON NULL'],
    ['published_at', 'DATETIME NULL'],
    ['hero_image', 'JSON NULL'],
    ['logo', 'JSON NULL'],
    ['logo_url', 'TEXT NULL'],
    ['logo_title', 'VARCHAR(255) NULL'],
